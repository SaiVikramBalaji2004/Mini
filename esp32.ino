...
const char* ssid = "Rudreshkarthi";         // Replace "xxx" with your WiFi SSID
const char* password = "rp22112026";      // Replace "xxx" with your WiFi Password
...
String apiKey = "AMD2ZB6m9kLX";             // Replace "xxx" with your API key
